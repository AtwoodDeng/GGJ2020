...
class UnityJellySpriteEditor : JellySpriteEditor
{
    ...
    public SerializedProperty m_SpriteMaterial;
	...
	protected override void OnEnable() 
	{
        ...
        m_SpriteMaterial = serializedObject.FindProperty("m_spriteMaterial");
    }
	
	protected override void DisplayInspectorGUI()
	{
		EditorGUILayout.PropertyField(m_Sprite, new GUIContent("Sprite"));
        EditorGUILayout.PropertyField(m_SpriteMaterial, new GUIContent("Sprite Material"));
